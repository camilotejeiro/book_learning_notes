...
\begin{document}
    ...
    From our previous chapter on special relativity we found that our observations 
    ...
    \begin{itemize}
        ...
        in a moving frame will appear to happen at different times (non-simultanous) 
    ...
    General relativity tells us that time can be appended to the Pythagoream 
